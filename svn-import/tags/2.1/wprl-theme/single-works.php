					...
					<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> >
						...
						<div class="entry-content">
							<div class="entry-meta">
									...
									{ ?>
										<span id="work-pages" class="metaspan"><?php _e('Pages:', 'wp_reading_list'); _e(get_post_meta($post->ID,'wprl_pages',true));?></span>
									<?php }
									if ($wprl_options['show_post_date'])
									{ ?>
											<span id="work-time" class="metaspan"><?php _e('Posted on:', 'wp_reading_list'); _e(the_date()); ?></span>
									<?php } 
									if ($wprl_options['post_author'])
									{ ?>
										<span id="post-author" class="metaspan"><?php _e('Posted By:', 'wp_reading_list');?> <a href="<?php _e(site_url());?>/author/<?php _e(the_author_meta('user_nicename', $post->post_author));?>"><?php _e(the_author_meta('user_nicename', $post->post_author));?></a></span>
									<?php }	
